...
namespace example
{
    public class Demo
    {
        ...
        public void GetOrderInfo()
        {
            ...
            orderNums.Add(new string[] { "41473642" });
            orderNums.Add(new string[] { "287811844" });
            orderNums.Add(new string[] { "105137040" });
            orderNums.Add(new string[] { "159243598" });
            orderNums.Add(new string[] { "145643595" });

            foreach (string[] sArray in orderNums)
            {
                Helper(sArray);
            }
        ...
        public void Helper(string[] orderNum)
        {
            ...
            foreach (var item in info.OrderInfoList)
            {
                Console.WriteLine(string.Format(item.ShipToFirstName + ": " + item.ShipToAddress1 + ": "
                    + item.ShipToZipCode + ": " + item.ShipToCountryCode + ": " + item.OrderNumber));
            }
        ...
        public void GetOrderStatus()
        {
            ...
            // Send your request and get response
            var orderstatus = ordercall.GetOrderStatus("423423678").Result;
